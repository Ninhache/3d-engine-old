...
private:
	/**
	 * @brief Returns all the textures corresponding to the type given
	 * in parameter
	 *
	 * @param material The materials associated with the mesh
	 * @param type The type of the texture (Ambiant, specular, ..)
	 *
	 * @note All possible texture types are declared in the material header
	 * of the assimp library, we do not support all of them for the moment,
	 * @ref see Texture
	 *
